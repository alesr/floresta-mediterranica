function revealConfig() {
  Reveal.initialize({
    ...
    parallaxBackgroundImage: '../images/Biodiversidade/fundoBiodiversidade.png', // e.g. "'https://s3.amazonaws.com/hakim-static/reveal-js/reveal-parallax-1.jpg'"
    ...
    dependencies: [
       { src: '../reveal/plugin/leap/leap.js', async: true }
    ]
  });
}
